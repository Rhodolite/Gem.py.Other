...
#
#   Tree: Subscript Expression, V1
#
class Tree_Subscript_Expression_V1(object):
    #
    #   implements Tree_Delete_Target,
    #              Tree_Expression,
    #              Tree_Store_Target
    ...
    #
    def __repr__(self):
        return arrange('<Tree_Subscript_Expression_V1 @{}:{} {!r} {!r} {!r}>',
                       self.line_number, self.column, self.value, self.index, self.context)


def create_Tree_Subscript_Expression_V1(line_number, column, value, index, context):
    assert fact_is_positive_integer   (line_number)
    assert fact_is_substantial_integer(column)
    ...
    return Tree_Subscript_Expression_V1(line_number, column, value, index, context)
