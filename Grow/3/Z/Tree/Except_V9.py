...
#
#   Z.Tree.Except_V9 - Implementation of `Tree_Except_Clause`, Version 9.
#
...
#       Version 8:
#
#           `.type_expression` is of type `None | Tree_Value_Expression`.
#
#       Version 8:
#
#           `.type_expression` is of type        `Tree_Value_Expression_0`.
#
