...
if __name__ == '__main__':
    ...
    def gem():
        ...
        #   LearningPython
        #
        LearningPython_name         = intern_string('LearningPython')
        LearningPython              = Module(LearningPython_name)
        LearningPython_scope        = LearningPython.__dict__
        LearningPython.__builtins__ = PythonBuiltIn.__dict__

        store_python_module(LearningPython_name, LearningPython)
        ...
        #
        #   export
        #       Exports a function to LearningPython; also the actual function exported
        ...
        #   share
        #
        insert_share = produce_single_insert('insert_share', LearningPython_scope.setdefault, LearningPython_name)
        share        = produce_actual_export(LearningPython_scope, insert_share)
        ...
        def gem(module_gem):
            def execute(f):
                Function(
                    function_code(f),
                    LearningPython_scope,       #   Replace global scope with LearningPython's shared scope
                    gem_name,
                    function_defaults(f),
                    function_closure(f),
                )(
                ...
                if f.__name__ == '__name__':
                    ...
                    #
                    main = LearningPython_scope.pop('main')
